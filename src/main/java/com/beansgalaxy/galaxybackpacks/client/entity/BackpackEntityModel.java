...
public class BackpackEntityModel<T extends Entity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData mask_r1 = body.addChild("mask_r1", ModelPartBuilder.create().uv(0, 21).cuboid(-4.0F, 9.0F, -2.0F, 8.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 7.0F, 0.0F, 3.1416F, 0.0F, 0.0F));
