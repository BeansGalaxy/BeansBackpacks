...
public class ItemRegistry {
    ...
    public static void registerItems() {
        BeansBackpacks.LOGGER.info("Registering Mod Items for" + BeansBackpacks.MODID);
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(BeansBackpacks.MODID, name), item);
    }
