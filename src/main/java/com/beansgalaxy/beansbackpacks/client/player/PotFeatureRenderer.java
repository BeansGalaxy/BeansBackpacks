...
import static com.beansgalaxy.beansbackpacks.client.RendererHelper.sneakInter;

public class PotFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>>
        extends FeatureRenderer<T, M> {

    public static final Identifier TEXTURE = new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay_detail.png");
