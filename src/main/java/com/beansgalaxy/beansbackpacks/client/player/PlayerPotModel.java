...
//		back.render(matrices, vBack, light, overlay, 1, 1, 1, 1);
	...
	public enum SherdTexture {
		ANGLER(			Items.ANGLER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/angler.png")),
		ARCHER(			Items.ARCHER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/archer.png")),
		ARMS_UP(		Items.ARMS_UP_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/arms_up.png")),
		BLADE(			Items.BLADE_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/blade.png")),
		BREWER(			Items.BREWER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/brewer.png")),
		BURN(			Items.BURN_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/burn.png")),
		DANGER(			Items.DANGER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/danger.png")),
		EXPLORER(		Items.EXPLORER_POTTERY_SHERD,		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/explorer.png")),
		FRIEND(			Items.FRIEND_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/friend.png")),
		HEART(			Items.HEART_POTTERY_SHERD,			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/heart.png")),
		HEARTBREAK(		Items.HEARTBREAK_POTTERY_SHERD,		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/heartbreak.png")),
		HOWL(			Items.HOWL_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/howl.png")),
		MINER(			Items.MINER_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/miner.png")),
		MOURNER(		Items.MOURNER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/mourner.png")),
		PLENTY(			Items.PLENTY_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/plenty.png")),
		PRIZE(			Items.PRIZE_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/prize.png")),
		SHEAF(			Items.SHEAF_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/sheaf.png")),
		SHELTER(		Items.SHELTER_POTTERY_SHERD, 		new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/shelter.png")),
		SKULL(			Items.SKULL_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/skull.png")),
		SNORT(			Items.SNORT_POTTERY_SHERD, 			new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay/snort.png"));

		public static final Identifier NONE = new Identifier(BeansBackpacks.MODID, "textures/entity/backpack/clay_none.png");
